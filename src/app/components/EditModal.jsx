...
import {Button, Input, Label, Modal, Surface, TextField, TextArea , ListBox , Select, FieldError} from "@heroui/react";


export default function EditModal({destination}) {

const {  _id, imageUrl, price , destinationName ,duration ,country,category, departureDate, description} = destination
  ...
  return (
    <div>
          <Modal>
      <Button variant="secondary" className={'border px-4 py-2 rounded-md text-sm'}>✎ Edit</Button>
      <Modal.Backdrop>
